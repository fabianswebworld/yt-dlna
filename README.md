...
- **Cast-to-UPnP bridge:** Shows up as a Cast receiver in the mobile YouTube app. Select **yt-dlna** and the video will instantly play ad-free on your UPnP-compatible TV or media player. No playlist configuration needed at all!
- **Play-To:** Play any online video instantly on your UPnP compatible TV by pasting its URL into a mobile-friendly "Play To" view (PWA capable) and tapping "Play to Renderer". No playlist configuration needed for this feature as well!
